...
pub fn list_users(client: &mut WListClient, token: &String, limit: u32, page: u32, direction: &OrderDirection) -> Result<Result<(u64, Vec<UserGroupInformation>), WrongStateError>, io::Error> {
