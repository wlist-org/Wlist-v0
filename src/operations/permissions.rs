...
impl From<&Permission> for String {
    fn from(value: &Permission) -> Self {
        String::from(match value {
            ...
            Permission::FilesBuildIndex => "FilesBuildIndex",
...
impl From<&String> for Permission {
    fn from(value: &String) -> Self {
        match value {
            ...
            v if v == "FilesBuildIndex" => Permission::FilesBuildIndex,
...
impl From<&Permission> for u64 {
    fn from(value: &Permission) -> Self {
        match value {
            ...
            Permission::FilesBuildIndex => 1 << 6,
            Permission::FilesList => 1 << 7,
            Permission::FileDownload => 1 << 8,
            Permission::FileUpload => 1 << 9,
            Permission::FileDelete => 1 << 10,
        }
    }
}
...
impl From<u64> for Permission {
    fn from(value: u64) -> Self {
        match value {
            ...
            v if v == 1 << 6 => Permission::FilesBuildIndex,
            v if v == 1 << 7 => Permission::FilesList,
            v if v == 1 << 8 => Permission::FileDownload,
            v if v == 1 << 9 => Permission::FileUpload,
            v if v == 1 << 10 => Permission::FileDelete,
            _ => Permission::Undefined,
        }
    }
}
