...
public record VisibleUserGroupInformation(long id, @NotNull String name, @NotNull EnumSet<@NotNull UserPermission> permissions,
    ...
    public static @NotNull VisibleUserGroupInformation parse(final @NotNull ByteBuf buffer) throws IOException {
        ...
        final EnumSet<UserPermission> permissions = Objects.requireNonNullElseGet(UserPermission.parse(ByteBufIOUtil.readUTF(buffer)), () -> EnumSet.noneOf(UserPermission.class));
