...
public final class WList {
    ...
    public static void main(final String @NotNull ... args) {
        ...
        try {
            ...
            logger.log(HLogLevel.LESS, "Initializing WList server environment.");
            ...
            ConstantManager.quicklyInitialize(new ConstantSqliteHelper(PooledSqlDatabase.quicklyOpen(databasePath)), "initialize");
            UserGroupManager.quicklyInitialize(new UserGroupSqliteHelper(PooledSqlDatabase.quicklyOpen(databasePath)), "initialize");
            UserManager.quicklyInitialize(new UserSqliteHelper(PooledSqlDatabase.quicklyOpen(databasePath)), "initialize");
