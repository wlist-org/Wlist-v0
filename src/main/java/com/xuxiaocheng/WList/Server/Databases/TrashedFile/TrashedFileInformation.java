...
public record TrashedFileInformation(@NotNull FileLocation location, @NotNull String name, boolean isDirectory, long size,
    ...
    public static @NotNull TrashedFileInformation fromFileSqlInformation(final @NotNull FileInformation information, final @Nullable LocalDateTime trashedTime, final @Nullable LocalDateTime expireTime) {
    ...
    public static void dumpVisible(final @NotNull ByteBuf buffer, final @NotNull TrashedFileInformation information) throws IOException {
