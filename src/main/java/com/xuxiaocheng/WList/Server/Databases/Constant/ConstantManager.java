...
public final class ConstantManager {
    ...
    public static final @NotNull HInitializer<Function<@NotNull PooledSqlDatabaseInterface, @NotNull ConstantSqlInterface>> Mapper = new HInitializer<>("ConstantSqlInstanceMapper",  d -> {
