...
public interface ServerHandler {
    ...
    @Contract(pure = true)
    static @NotNull String user(final @Nullable String user, final long id, final @NotNull String username) {
        return String.format(" %s: (id=%d, name='%s')", Objects.requireNonNullElse(user, "user"), id, username);
    }
    ...
    @Contract(pure = true)
    static @NotNull String userGroup(final @Nullable String group, final long id, final @NotNull String groupName) {
        return String.format(" %s: (id=%d, name='%s')", Objects.requireNonNullElse(group, "group"), id, groupName);
    }
